...
<body>
    <center><h3 class="text-center mb-4"> Data Major</h3></center>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="cd_major" require="required"> 
                            </div>
                            <div class="form-group">
                                <label for="nm_major" class="form-label">Nama Jurusan</label><br>
                                <input type="text" class="form-control" name="nm_major" require="required"> 
                            </div>
